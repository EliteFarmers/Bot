...
async function execute(interaction: ButtonInteraction, settings: UserSettings) {
	...
	embed.addFields({
		...
		value: 'Collection increases are stored in the Elite Farmers API\'s database every time new data is fetched from Hypixel, this is not an automatic process.',
	}, {
		name: 'Why is a day really high?',
		value: 'If a particular day is really high, it is likely that the player has not been updated for a while before that day. For example, if a player has not been updated for 3 days, the collection increase for the 3rd day will be the sum of the 1st, 2nd, and 3rd day. This may also be due to collecting minions.',
	}, {
		name: 'What are the timestamps?',
		value: 'These timestamps represent the start of the day in UTC. A player\'s first and last data point of that day is what is used to calculate the collection increase.',
	}, {
