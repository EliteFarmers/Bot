 ...
 */
import type { ContestParticipationWithTimestampDto } from './ContestParticipationWithTimestampDto';

export type YearlyCropRecordsDtoCrops = { [key: string]: ContestParticipationWithTimestampDto[] };
