 ...
 */
import type { FarmDesignData } from './FarmDesignData';
import type { GreenhouseLayout } from './GreenhouseLayout';

export interface GuideRichData {
	greenhouseLayout?: GreenhouseLayout | null;
	farmDesign?: FarmDesignData | null;
}
