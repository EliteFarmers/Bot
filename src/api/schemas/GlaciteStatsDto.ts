 ...
 */
import type { GlaciteStatsDtoCorpsesLooted } from './GlaciteStatsDtoCorpsesLooted';

export interface GlaciteStatsDto {
	fossilsDonated: string[];
	fossilsDonatedCount: number;
	fossilDust: number;
	corpsesLooted: GlaciteStatsDtoCorpsesLooted;
