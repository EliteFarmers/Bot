 ...
 */
import type { DictionaryOfStringAndSkyblockItemResponse } from './DictionaryOfStringAndSkyblockItemResponse';

export interface GetSpecifiedSkyblockItemsResponse {
	items: DictionaryOfStringAndSkyblockItemResponse;
}
