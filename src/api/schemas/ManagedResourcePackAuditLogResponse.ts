 ...
 */
import type { ManagedResourcePackAuditLogDto } from './ManagedResourcePackAuditLogDto';

export interface ManagedResourcePackAuditLogResponse {
	offset: number;
	limit: number;
	totalCount: number;
	logs: ManagedResourcePackAuditLogDto[];
}
