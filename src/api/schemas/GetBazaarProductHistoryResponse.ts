 ...
 */
import type { BazaarHistoryDataPoint } from './BazaarHistoryDataPoint';
import type { BazaarProductSummaryDto } from './BazaarProductSummaryDto';

export interface GetBazaarProductHistoryResponse {
	productId: string;
	product: BazaarProductSummaryDto;
	history: BazaarHistoryDataPoint[];
}
