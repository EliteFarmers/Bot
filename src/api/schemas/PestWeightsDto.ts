 ...
 */
import type { PestWeightsDtoBrackets } from './PestWeightsDtoBrackets';
import type { PestWeightsDtoValues } from './PestWeightsDtoValues';

export interface PestWeightsDto {
	brackets: PestWeightsDtoBrackets;
	values: PestWeightsDtoValues;
}
