 ...
 */
import type { MemberLeaderboardCosmeticsDto } from './MemberLeaderboardCosmeticsDto';

export interface MemberCosmeticsDto {
	/**
	 * @maxLength 16
	 * @nullable
	 */
	 ...
	 */
	suffix?: string | null;
	leaderboard?: MemberLeaderboardCosmeticsDto | null;
}
