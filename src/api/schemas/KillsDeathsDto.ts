 ...
 */
import type { KillsDeathsDtoDeaths } from './KillsDeathsDtoDeaths';
import type { KillsDeathsDtoKills } from './KillsDeathsDtoKills';

export interface KillsDeathsDto {
	totalKills: number;
	totalDeaths: number;
	kills: KillsDeathsDtoKills;
	deaths: KillsDeathsDtoDeaths;
}
