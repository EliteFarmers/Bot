 ...
 */
import type { WeightStyleDecalCrops } from './WeightStyleDecalCrops';
import type { WeightStylePosition } from './WeightStylePosition';

export interface WeightStyleDecal {
	start: WeightStylePosition;
	end: WeightStylePosition;
	/** @nullable */
	fill?: string | null;
	/** @nullable */
	imageUrl?: string | null;
	/** @nullable */
	crops?: WeightStyleDecalCrops;
}
