 ...
 */
import type { GetBazaarProductsResponseProducts } from './GetBazaarProductsResponseProducts';

export interface GetBazaarProductsResponse {
	products: GetBazaarProductsResponseProducts;
}
