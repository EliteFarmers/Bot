 ...
 */
import type { HypixelGuildSearchResultDto } from './HypixelGuildSearchResultDto';

export interface SearchHypixelGuildsResponse {
	results: HypixelGuildSearchResultDto[];
}
