 ...
 */
import type { DungeonClassData } from './DungeonClassData';

export interface DungeonPlayerClasses {
	healer: DungeonClassData;
	mage: DungeonClassData;
	berserk: DungeonClassData;
	archer: DungeonClassData;
	tank: DungeonClassData;
}
