 ...
 */
import type { DictionaryOfStringAndContestBracketsDto } from './DictionaryOfStringAndContestBracketsDto';

export interface ContestBracketsDetailsDto {
	start: string;
	end: string;
	brackets: DictionaryOfStringAndContestBracketsDto;
}
