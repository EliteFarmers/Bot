 ...
 */
import type { CropCollectionsDataPointDtoCrops } from './CropCollectionsDataPointDtoCrops';
import type { CropCollectionsDataPointDtoPests } from './CropCollectionsDataPointDtoPests';

export interface CropCollectionsDataPointDto {
	timestamp: number;
	cropWeight: string;
	crops: CropCollectionsDataPointDtoCrops;
	pests: CropCollectionsDataPointDtoPests;
}
