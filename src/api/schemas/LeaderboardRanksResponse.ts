 ...
 */
import type { LeaderboardRanksResponseRanks } from './LeaderboardRanksResponseRanks';

export interface LeaderboardRanksResponse {
	ranks: LeaderboardRanksResponseRanks;
}
