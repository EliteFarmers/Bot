 ...
 */
import type { HarvestFeastCurrentRequestNext } from './HarvestFeastCurrentRequestNext';

export interface HarvestFeastCurrentRequest {
	current: string[];
	next: HarvestFeastCurrentRequestNext;
