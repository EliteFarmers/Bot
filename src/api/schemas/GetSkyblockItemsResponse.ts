 ...
 */
import type { GetSkyblockItemsResponseItems } from './GetSkyblockItemsResponseItems';

export interface GetSkyblockItemsResponse {
	items: GetSkyblockItemsResponseItems;
}
