 ...
 */
import type { ManagedResourcePackVersionListItemDto } from './ManagedResourcePackVersionListItemDto';

export interface ManagedResourcePackVersionListResponse {
	offset: number;
	limit: number;
	totalCount: number;
	versions: ManagedResourcePackVersionListItemDto[];
}
