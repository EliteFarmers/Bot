 ...
 */
import type { BazaarOverviewItemDto } from './BazaarOverviewItemDto';

export interface BazaarOverviewResponse {
	topMovers: BazaarOverviewItemDto[];
	mostTraded: BazaarOverviewItemDto[];
}
