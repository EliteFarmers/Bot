 ...
 */
import type { LeaderboardPlacementRecap } from './LeaderboardPlacementRecap';
import type { MonthlyLeaderboardRecap } from './MonthlyLeaderboardRecap';

export interface LeaderboardRecap {
	top1000: LeaderboardPlacementRecap[];
	monthlyHighs: MonthlyLeaderboardRecap[];
}
