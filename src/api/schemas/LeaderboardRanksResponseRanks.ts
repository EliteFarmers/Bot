 ...
 */
import type { PlayerLeaderboardEntryWithRankDto } from './PlayerLeaderboardEntryWithRankDto';

export type LeaderboardRanksResponseRanks = { [key: string]: PlayerLeaderboardEntryWithRankDto };
