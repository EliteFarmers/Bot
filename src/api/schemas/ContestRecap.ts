 ...
 */
import type { ContestPlacementRecap } from './ContestPlacementRecap';
import type { ContestRecapPerCrop } from './ContestRecapPerCrop';

export interface ContestRecap {
	total: number;
	perCrop: ContestRecapPerCrop;
	highestPlacements: ContestPlacementRecap[];
}
