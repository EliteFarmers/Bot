...
export const getGetAccountFromDiscordUrl = (discordId: number) => {
	return `${ELITE_API_URL}/account/${discordId}`;
};

export const getAccountFromDiscord = async (discordId: number, options?: RequestInit) => {
...
/**
 * @summary Reconcile User Purchases
 */
export type reconcileUserPurchasesResponse200 = {
	data: ReconciliationResultDto;
	status: 200;
};

export type reconcileUserPurchasesResponse401 = {
	data: void;
	status: 401;
};

export type reconcileUserPurchasesResponse403 = {
	data: void;
	status: 403;
};

export type reconcileUserPurchasesResponseSuccess = reconcileUserPurchasesResponse200 & {
	headers: Headers;
};
export type reconcileUserPurchasesResponseError = (
	| reconcileUserPurchasesResponse401
	| reconcileUserPurchasesResponse403
) & {
	headers: Headers;
};

export type reconcileUserPurchasesResponse =
	| reconcileUserPurchasesResponseSuccess
	| reconcileUserPurchasesResponseError;

export const getReconcileUserPurchasesUrl = () => {
	return `${ELITE_API_URL}/account/purchases/reconcile`;
};

export const reconcileUserPurchases = async (options?: RequestInit) => {
	return customFetch<reconcileUserPurchasesResponse>(getReconcileUserPurchasesUrl(), {
		...options,
		method: 'POST',
	});
};
...
export const getAddRoleToUserUrl = (discordId: number, role: string) => {
	return `${ELITE_API_URL}/admin/user/${discordId}/roles/${role}`;
};

export const addRoleToUser = async (discordId: number, role: string, options?: RequestInit) => {
...
export const getRemoveRoleFromUserUrl = (discordId: number, role: string) => {
	return `${ELITE_API_URL}/admin/user/${discordId}/roles/${role}`;
};

export const removeRoleFromUser = async (discordId: number, role: string, options?: RequestInit) => {
...
export const getDeleteEventApprovalUrl = (eventId: number) => {
	return `${ELITE_API_URL}/admin/events/${eventId}`;
};

export const deleteEventApproval = async (eventId: number, options?: RequestInit) => {
...
export const getSetEventApprovalUrl = (eventId: number, params?: SetEventApprovalParams) => {
	const normalizedParams = new URLSearchParams();
...
export const setEventApproval = async (eventId: number, params?: SetEventApprovalParams, options?: RequestInit) => {
...
export const getRefreshDiscordGuildUrl = (guildId: number) => {
	return `${ELITE_API_URL}/admin/guild/${guildId}/refresh`;
};

export const refreshDiscordGuild = async (guildId: number, options?: RequestInit) => {
...
export const getAcceptConfirmationUrl = (id: number) => {
	return `${ELITE_API_URL}/auth/confirmations/${id}/accept`;
};

export const acceptConfirmation = async (id: number, options?: RequestInit) => {
...
export const getGetConfirmationUrl = (id: number) => {
	return `${ELITE_API_URL}/auth/confirmations/${id}`;
};

export const getConfirmation = async (id: number, options?: RequestInit) => {
...
export const updateBadge = async (
	...
	if (updateBadgeRequestUpdateBadge.requirements !== undefined && updateBadgeRequestUpdateBadge.requirements !== null) {
...
export const getUpdateGuildUrl = (discordId: number) => {
	return `${ELITE_API_URL}/bot/guild/${discordId}`;
};

export const updateGuild = async (discordId: number, incomingGuildDto: IncomingGuildDto, options?: RequestInit) => {
...
export const getDeleteConfirmationUrl = (id: number) => {
	return `${ELITE_API_URL}/admin/confirmations/${id}`;
};

export const deleteConfirmation = async (id: number, options?: RequestInit) => {
...
export const getUpdateConfirmationUrl = (id: number) => {
	return `${ELITE_API_URL}/admin/confirmations/${id}`;
};
...
export const getBanMemberAdminUrl = (discordId: number, eventId: number, playerUuid: string) => {
...
export const getUnbanMemberAdminUrl = (discordId: number, eventId: number, playerUuid: string) => {
	return `${ELITE_API_URL}/guild/${discordId}/events/${eventId}/bans/${playerUuid}`;
};
...
export const getCreateEventAdminUrl = (discordId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/events/weight`;
};

export const createEventAdmin = async (discordId: number, createEventDto: CreateEventDto, options?: RequestInit) => {
...
export const getCreateTeamAdminUrl = (discordId: number, eventId: number, params?: CreateTeamAdminParams) => {
	const normalizedParams = new URLSearchParams();
...
export const getDeleteEventAdminUrl = (discordId: number, eventId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/events/${eventId}`;
};

export const deleteEventAdmin = async (discordId: number, eventId: number, options?: RequestInit) => {
...
export const getUpdateEventAdminUrl = (discordId: number, eventId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/events/${eventId}`;
};
...
export const getDeleteEventBannerAdminUrl = (discordId: number, eventId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/events/${eventId}/banner`;
};

export const deleteEventBannerAdmin = async (discordId: number, eventId: number, options?: RequestInit) => {
...
export const getSetEventBannerAdminUrl = (discordId: number, eventId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/events/${eventId}/banner`;
};
...
export const getDeleteTeamAdminUrl = (discordId: number, eventId: number, teamId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/events/${eventId}/teams/${teamId}`;
};

export const deleteTeamAdmin = async (discordId: number, eventId: number, teamId: number, options?: RequestInit) => {
...
export const getUpdateTeamAdminUrl = (discordId: number, eventId: number, teamId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/events/${eventId}/teams/${teamId}`;
};
...
export const getGetBannedMembersAdminUrl = (discordId: number, eventId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/event/${eventId}/bans`;
};

export const getBannedMembersAdmin = async (discordId: number, eventId: number, options?: RequestInit) => {
...
export const getGetGuildEventMembersAdminUrl = (discordId: number, eventId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/event/${eventId}/members`;
};

export const getGuildEventMembersAdmin = async (discordId: number, eventId: number, options?: RequestInit) => {
...
export const getGetGuildEventAdminUrl = (discordId: number, eventId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/event/${eventId}/admin`;
};

export const getGuildEventAdmin = async (discordId: number, eventId: number, options?: RequestInit) => {
...
export const getGetGuildEventsAdminUrl = (discordId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/events/admin`;
};

export const getGuildEventsAdmin = async (discordId: number, options?: RequestInit) => {
...
export const getGetTeamsAdminUrl = (discordId: number, eventId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/event/${eventId}/teams`;
};

export const getTeamsAdmin = async (discordId: number, eventId: number, options?: RequestInit) => {
...
export const getApproveCommentUrl = (commentId: number) => {
	return `${ELITE_API_URL}/admin/comments/${commentId}/approve`;
};

export const approveComment = async (commentId: number, options?: RequestInit) => {
...
export const getApproveGuideUrl = (guideId: number) => {
	return `${ELITE_API_URL}/admin/guides/${guideId}/approve`;
};

export const approveGuide = async (guideId: number, options?: RequestInit) => {
...
export const getBookmarkGuideUrl = (guideId: number) => {
	return `${ELITE_API_URL}/guides/${guideId}/bookmark`;
};

export const bookmarkGuide = async (guideId: number, options?: RequestInit) => {
...
export const getUnbookmarkGuideUrl = (guideId: number) => {
	return `${ELITE_API_URL}/guides/${guideId}/bookmark`;
};

export const unbookmarkGuide = async (guideId: number, options?: RequestInit) => {
...
export const getCreateCommentUrl = (guideId: number) => {
...
export const deleteGuide = async (id: number, options?: RequestInit) => {
...
export const updateGuide = async (id: number, updateGuideRequest: UpdateGuideRequest, options?: RequestInit) => {
...
export const deleteTag = async (id: number, options?: RequestInit) => {
...
export const updateTag = async (id: number, updateTagRequest: UpdateTagRequest, options?: RequestInit) => {
...
export const editComment = async (commentId: number, editCommentRequest: EditCommentRequest, options?: RequestInit) => {
...
export const getGetUserBookmarksUrl = (accountId: number) => {
	return `${ELITE_API_URL}/users/${accountId}/bookmarks`;
};

export const getUserBookmarks = async (accountId: number, options?: RequestInit) => {
...
export const getGetUserGuidesUrl = (accountId: number) => {
	return `${ELITE_API_URL}/users/${accountId}/guides`;
};

export const getUserGuides = async (accountId: number, options?: RequestInit) => {
...
export const getRejectGuideUrl = (guideId: number) => {
	return `${ELITE_API_URL}/admin/guides/${guideId}/reject`;
};

export const rejectGuide = async (guideId: number, rejectGuideRequest: RejectGuideRequest, options?: RequestInit) => {
...
export const getSubmitGuideForApprovalUrl = (guideId: number) => {
	return `${ELITE_API_URL}/guides/${guideId}/submit`;
};

export const submitGuideForApproval = async (guideId: number, options?: RequestInit) => {
...
export const getUnpublishGuideUrl = (guideId: number) => {
	return `${ELITE_API_URL}/guides/${guideId}/unpublish`;
};

export const unpublishGuide = async (guideId: number, options?: RequestInit) => {
...
export const getVoteCommentUrl = (commentId: number) => {
	return `${ELITE_API_URL}/comments/${commentId}/vote`;
};

export const voteComment = async (commentId: number, voteCommentRequest: VoteCommentRequest, options?: RequestInit) => {
...
export const getVoteGuideUrl = (guideId: number) => {
	return `${ELITE_API_URL}/guides/${guideId}/vote`;
};

export const voteGuide = async (guideId: number, voteGuideRequest: VoteGuideRequest, options?: RequestInit) => {
...
export const getSetEventFeatureUrl = (discordId: number, params?: SetEventFeatureParams) => {
	const normalizedParams = new URLSearchParams();
...
export const setEventFeature = async (discordId: number, params?: SetEventFeatureParams, options?: RequestInit) => {
...
export const getGetPublicGuildEventsUrl = (discordId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}/events`;
};

export const getPublicGuildEvents = async (discordId: number, options?: RequestInit) => {
...
export const getSetJacobFeatureUrl = (discordId: number, params?: SetJacobFeatureParams) => {
	const normalizedParams = new URLSearchParams();
...
export const setJacobFeature = async (discordId: number, params?: SetJacobFeatureParams, options?: RequestInit) => {
...
export const getSetGuildLockedUrl = (discordId: number, params?: SetGuildLockedParams) => {
	const normalizedParams = new URLSearchParams();
...
export const setGuildLocked = async (discordId: number, params?: SetGuildLockedParams, options?: RequestInit) => {
...
export const getSetGuildPublicUrl = (discordId: number, params?: SetGuildPublicParams) => {
	const normalizedParams = new URLSearchParams();
...
export const setGuildPublic = async (discordId: number, params?: SetGuildPublicParams, options?: RequestInit) => {
...
export const getGetPublicGuildUrl = (discordId: number) => {
	return `${ELITE_API_URL}/guild/${discordId}`;
};

export const getPublicGuild = async (discordId: number, options?: RequestInit) => {
...
export const getDeleteContestPingsUrl = (discordId: number, params?: DeleteContestPingsParams) => {
	const normalizedParams = new URLSearchParams();
...
export const getUpdateContestPingsUrl = (discordId: number) => {
...
export const getGetUserGuildUrl = (discordId: number) => {
	return `${ELITE_API_URL}/user/guild/${discordId}`;
};

export const getUserGuild = async (discordId: number, options?: RequestInit) => {
...
export const getCreateGuildJacobLeaderboardUrl = (discordId: number) => {
...
export const getDeleteGuildJacobLeaderboardUrl = (discordId: number, leaderboardId: string) => {
	return `${ELITE_API_URL}/user/guild/${discordId}/jacob/${leaderboardId}`;
};

export const deleteGuildJacobLeaderboard = async (discordId: number, leaderboardId: string, options?: RequestInit) => {
	return customFetch<deleteGuildJacobLeaderboardResponse>(getDeleteGuildJacobLeaderboardUrl(discordId, leaderboardId), {
		...options,
		method: 'DELETE',
	});
};
...
export const getUpdateGuildJacobLeaderboardUrl = (discordId: number, leaderboardId: string) => {
	return `${ELITE_API_URL}/user/guild/${discordId}/jacob/${leaderboardId}`;
};
...
export const updateGuildJacobLeaderboard = async (
	...
	return customFetch<updateGuildJacobLeaderboardResponse>(getUpdateGuildJacobLeaderboardUrl(discordId, leaderboardId), {
		...options,
		method: 'PATCH',
		headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGetGuildJacobUrl = (discordId: number) => {
	return `${ELITE_API_URL}/user/guild/${discordId}/jacob`;
};

export const getGuildJacob = async (discordId: number, options?: RequestInit) => {
...
export const getUpdateGuildJacobFeatureUrl = (discordId: number, params?: UpdateGuildJacobFeatureParams) => {
	const normalizedParams = new URLSearchParams();
...
export const getAddJacobLeaderboardExcludedTimespanUrl = (discordId: number) => {
...
export const getBanParticipationFromJacobLeaderboardUrl = (discordId: number) => {
...
export const getBanPlayerFromJacobLeaderboardUrl = (discordId: number) => {
...
export const getRemoveJacobLeaderboardExcludedTimespanUrl = (discordId: number, start: number, end: number) => {
...
export const getUnbanParticipationFromJacobLeaderboardUrl = (discordId: number, participationId: string) => {
...
export const getUnbanPlayerFromJacobLeaderboardUrl = (discordId: number, playerUuid: string) => {
	return `${ELITE_API_URL}/guilds/${discordId}/jacob/bans/players/${playerUuid}`;
};

export const unbanPlayerFromJacobLeaderboard = async (discordId: number, playerUuid: string, options?: RequestInit) => {
...
export const getSendGuildJacobFeatureUrl = (discordId: number, leaderboardId: string) => {
	return `${ELITE_API_URL}/user/guild/${discordId}/jacob/${leaderboardId}/send`;
};

export const sendGuildJacobFeature = async (discordId: number, leaderboardId: string, options?: RequestInit) => {
...
export const getRequestGuildRefreshUrl = (discordId: number) => {
	return `${ELITE_API_URL}/user/guild/${discordId}/refresh`;
};

export const requestGuildRefresh = async (discordId: number, options?: RequestInit) => {
...
export const getSetAdminRoleUrl = (discordId: number) => {
	return `${ELITE_API_URL}/user/guild/${discordId}/adminrole`;
};

export const setAdminRole = async (discordId: number, setAdminRoleBody: string, options?: RequestInit) => {
...
export const getSetInviteUrl = (discordId: number) => {
	return `${ELITE_API_URL}/user/guild/${discordId}/invite`;
};

export const setInvite = async (discordId: number, setInviteBody: string, options?: RequestInit) => {
...
export const getUpdateGuildPurchasesUrl = (discordId: number) => {
	return `${ELITE_API_URL}/user/guild/${discordId}/purchases`;
};

export const updateGuildPurchases = async (discordId: number, options?: RequestInit) => {
...
export const getGetEntitlementsUrl = (discordId: number, params?: GetEntitlementsParams) => {
	const normalizedParams = new URLSearchParams();
...
export const getEntitlements = async (discordId: number, params?: GetEntitlementsParams, options?: RequestInit) => {
 ...
 */
export type getTebexProductSettingsResponse200 = {
	data: TebexProductSettingsDto;
	status: 200;
};

export type getTebexProductSettingsResponse401 = {
	data: void;
	status: 401;
};

export type getTebexProductSettingsResponse403 = {
	data: void;
	status: 403;
};

export type getTebexProductSettingsResponseSuccess = getTebexProductSettingsResponse200 & {
	headers: Headers;
};
export type getTebexProductSettingsResponseError = (
	| getTebexProductSettingsResponse401
	| getTebexProductSettingsResponse403
) & {
	headers: Headers;
};

export type getTebexProductSettingsResponse =
	| getTebexProductSettingsResponseSuccess
	| getTebexProductSettingsResponseError;

export const getGetTebexProductSettingsUrl = (productId: string) => {
	return `${ELITE_API_URL}/admin/products/${productId}/providers/tebex`;
};

export const getTebexProductSettings = async (productId: string, options?: RequestInit) => {
	return customFetch<getTebexProductSettingsResponse>(getGetTebexProductSettingsUrl(productId), {
		...options,
		method: 'GET',
	});
};
 ...
 */
export type upsertTebexProductSettingsResponse200 = {
	data: TebexProductSettingsDto;
	status: 200;
};

export type upsertTebexProductSettingsResponse401 = {
	data: void;
	status: 401;
};

export type upsertTebexProductSettingsResponse403 = {
	data: void;
	status: 403;
};

export type upsertTebexProductSettingsResponseSuccess = upsertTebexProductSettingsResponse200 & {
	headers: Headers;
};
export type upsertTebexProductSettingsResponseError = (
	| upsertTebexProductSettingsResponse401
	| upsertTebexProductSettingsResponse403
) & {
	headers: Headers;
};

export type upsertTebexProductSettingsResponse =
	| upsertTebexProductSettingsResponseSuccess
	| upsertTebexProductSettingsResponseError;

export const getUpsertTebexProductSettingsUrl = (productId: string) => {
	return `${ELITE_API_URL}/admin/products/${productId}/providers/tebex`;
};

export const upsertTebexProductSettings = async (
	productId: string,
	upsertTebexProductSettingsRequest: UpsertTebexProductSettingsRequest,
	options?: RequestInit,
) => {
	return customFetch<upsertTebexProductSettingsResponse>(getUpsertTebexProductSettingsUrl(productId), {
		...options,
		method: 'PUT',
		headers: { 'Content-Type': 'application/json', ...options?.headers },
		body: JSON.stringify(upsertTebexProductSettingsRequest),
	});
};
...
/**
 * @summary Handle Tebex Webhook
 */
export type hiddenTebexWebhookResponse204 = {
	data: void;
	status: 204;
};

export type hiddenTebexWebhookResponseSuccess = hiddenTebexWebhookResponse204 & {
	headers: Headers;
};

export type hiddenTebexWebhookResponse = hiddenTebexWebhookResponseSuccess;

export const getHiddenTebexWebhookUrl = () => {
	return `${ELITE_API_URL}/webhooks/tebex`;
};

export const hiddenTebexWebhook = async (options?: RequestInit) => {
	return customFetch<hiddenTebexWebhookResponse>(getHiddenTebexWebhookUrl(), {
		...options,
		method: 'POST',
	});
};
...
export const getGetLinkedAccountsUrl = (discordId: number) => {
	return `${ELITE_API_URL}/player/${discordId}`;
};

export const getLinkedAccounts = async (discordId: number, options?: RequestInit) => {
...
export const getGetPlayerRecapUrl = (year: number, playerUuid: string, profileUuid: string) => {
	return `${ELITE_API_URL}/recap/${year}/player/${playerUuid}/${profileUuid}`;
};

export const getPlayerRecap = async (year: number, playerUuid: string, profileUuid: string, options?: RequestInit) => {
...
export const getToggleRecapVisibilityUrl = (year: number, playerUuid: string, profileUuid: string) => {
...
export const getAddCategoryBannerUrl = (categoryId: number) => {
	return `${ELITE_API_URL}/shop/category/${categoryId}/banner`;
};

export const addCategoryBanner = async (categoryId: number, uploadImageDto: UploadImageDto, options?: RequestInit) => {
	const formData = new FormData();
...
export const getAddProductToCategoryUrl = (categoryId: number, productId: number) => {
	return `${ELITE_API_URL}/shop/category/${categoryId}/product/${productId}`;
};

export const addProductToCategory = async (categoryId: number, productId: number, options?: RequestInit) => {
...
export const getRemoveProductToCategoryUrl = (categoryId: number, productId: number) => {
	return `${ELITE_API_URL}/shop/category/${categoryId}/product/${productId}`;
};

export const removeProductToCategory = async (categoryId: number, productId: number, options?: RequestInit) => {
...
export const getAssignArtistUrl = (categoryId: number, accountId: number) => {
	return `${ELITE_API_URL}/shop/category/${categoryId}/artist/${accountId}`;
};

export const assignArtist = async (categoryId: number, accountId: number, options?: RequestInit) => {
...
export const getUnassignArtistUrl = (categoryId: number) => {
	return `${ELITE_API_URL}/shop/category/${categoryId}/artist`;
};

export const unassignArtist = async (categoryId: number, options?: RequestInit) => {
...
export const getAddCosmeticToProductUrl = (productId: number, cosmeticId: number) => {
	return `${ELITE_API_URL}/product/${productId}/cosmetics/${cosmeticId}`;
};

export const addCosmeticToProduct = async (productId: number, cosmeticId: number, options?: RequestInit) => {
...
export const getRemoveCosmeticToProductUrl = (productId: number, cosmeticId: number) => {
	return `${ELITE_API_URL}/product/${productId}/cosmetics/${cosmeticId}`;
};

export const removeCosmeticToProduct = async (productId: number, cosmeticId: number, options?: RequestInit) => {
...
export const getAddProductImageUrl = (discordId: number, params?: AddProductImageParams) => {
	const normalizedParams = new URLSearchParams();
...
export const getDeleteProductImageUrl = (discordId: number, imagePath: string) => {
	return `${ELITE_API_URL}/product/${discordId}/images/${imagePath}`;
};

export const deleteProductImage = async (discordId: number, imagePath: string, options?: RequestInit) => {
...
export const getUpdateProductUrl = (discordId: number) => {
	return `${ELITE_API_URL}/product/${discordId}`;
};

export const updateProduct = async (discordId: number, editProductDto: EditProductDto, options?: RequestInit) => {
...
export const getClaimProductUrl = (discordId: number) => {
	return `${ELITE_API_URL}/product/${discordId}/claim`;
};

export const claimProduct = async (discordId: number, options?: RequestInit) => {
...
export const getReassignStyleUrl = (styleId: number, accountId: number) => {
	return `${ELITE_API_URL}/product/style/${styleId}/artist/${accountId}`;
};

export const reassignStyle = async (styleId: number, accountId: number, options?: RequestInit) => {
 ...
 */
export type getWeightsResponse200 = {
	data: GetWeights200;
	status: 200;
};

export type getWeightsResponseSuccess = getWeightsResponse200 & {
	headers: Headers;
};

export type getWeightsResponse = getWeightsResponseSuccess;

export const getGetWeightsUrl = () => {
	return `${ELITE_API_URL}/weights`;
};

export const getWeights = async (options?: RequestInit) => {
	return customFetch<getWeightsResponse>(getGetWeightsUrl(), {
		...options,
		method: 'GET',
	});
};
